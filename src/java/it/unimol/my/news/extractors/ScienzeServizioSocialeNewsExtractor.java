 ...
 * @author Carlo Branca
 */
public class ScienzeServizioSocialeNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getScienzeServizioSocialeNewsBoardUrl();
