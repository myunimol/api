 ...
 * @author Carlo Branca
 */
public class ScienzePoliticheIstituzioniEuropeeNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getScienzePoliticheIstituzioniEuropeeNewsBoardUrl();
