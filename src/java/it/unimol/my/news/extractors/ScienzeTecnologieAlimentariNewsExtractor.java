 ...
 * @author Carlo Branca
 */
public class ScienzeTecnologieAlimentariNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getScienzeTecnologieAlimentariNewsBoardUrl();
