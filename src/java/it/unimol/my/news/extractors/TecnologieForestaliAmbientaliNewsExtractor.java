 ...
 * @author Carlo Branca
 */
public class TecnologieForestaliAmbientaliNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getTecnologieForestaliAmbientaliNewsBoardUrl();
