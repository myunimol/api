 ...
 * @author Carlo Branca
 */
public class TurismoBeniCulturaliNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getTurismoBeniCulturaliNewsBoardUrl();
