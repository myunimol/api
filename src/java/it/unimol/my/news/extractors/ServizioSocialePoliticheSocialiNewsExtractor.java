 ...
 * @author Carlo Branca
 */
public class ServizioSocialePoliticheSocialiNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getServizioSocialePoliticheSocialiNewsBoardUrl();
