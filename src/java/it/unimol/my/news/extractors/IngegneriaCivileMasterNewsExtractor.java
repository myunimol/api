 ...
 * @author Carlo Branca
 */
public class IngegneriaCivileMasterNewsExtractor extends BlogNewsExtractor {

	@Override
	public List<News> getNewsList() {
		String url = ConfigurationManager.getInstance().getIngegneriaCivileMasterNewsBoardUrl();
